...
exports.seed = (knex) => {
  ...
  // Inserts ALL existing tables
    .then(() => knex('users').insert([
      { id: 10000, name: 'User #1', mail: 'user1@bmail.com', passwd: '$2a$10$AHRKVQBtP/YDjpNVbrVwiuvWwB6xRNrvQE83v2jcojEvLt2YnTXGG' },
      { id: 10001, name: 'User #2', mail: 'user2@bmail.com', passwd: '$2a$10$AHRKVQBtP/YDjpNVbrVwiuvWwB6xRNrvQE83v2jcojEvLt2YnTXGG' },
    ]))
